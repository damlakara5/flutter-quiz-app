...
class Quiz_almanca extends StatefulWidget {
  Quiz_almanca({Key? key}) : super(key: key);

  @override
  State<Quiz_almanca> createState() => _QuizState();
}

class _QuizState extends State<Quiz_almanca> {
  SqlDb sqlDb = SqlDb();
      ...
      home: Scaffold(
        ...
        drawer: new Drawer(
          ...
          child: new Column(
            ...
            children: <Widget>[
              Container(
                  margin:
                      EdgeInsets.only(top: 90, left: 40, right: 40, bottom: 40),
                  child: Text(
                    "Soru Sayısı:  ${benimTestim.Sorular.length}",
              ...
              Container(
                  ...
                  child: Text(
                    "Çözdüğüm Soru Sayısı: ${benimTestim.aktifSoru}",
                    style: TextStyle(fontSize: 20),
                  )),
              Text(
                "------------------------------------",
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      showtimer,
                      style: TextStyle(
                          fontSize: 28, color: Color.fromARGB(255, 255, 5, 5)),
                    ),
                  ],
                ),
              ),
        ...
        body: Column(
          children: [
            ...
            Expanded(
              child: Center(
                child: Text(benimTestim.soruYaz(),
                    style: TextStyle(
                        fontSize: 30,
            ...
            Row(
              children: benimTestim.d_y_bilgisi,
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Row(
                children: [
                  Container(
                    ...
                    child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                          primary: Color.fromRGBO(133, 173, 210, 1),
                        ),
                        onPressed: () {},
                        child: Text(
                          showtimer,
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                          primary: Color.fromRGBO(61, 102, 140, 1),
                        ),
                        onPressed: () {
