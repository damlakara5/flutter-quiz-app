    ...
    return Scaffold (
        backgroundColor: Color.fromRGBO( 133, 173, 210, 1),
          body:  Column(
           ...
           Container( margin: EdgeInsets.only(left: 60, right: 60, top: 60),
             child: CircleAvatar(
               backgroundColor: Color.fromARGB(255, 66, 181, 21),
                radius: 100, 
                child: Text("Doğru Sayınız: ${benimTestim.printD()}", style: TextStyle(fontSize: 20 ,color: Color.fromRGBO(0, 0, 0, 1))),),
           ),
               Container( margin: EdgeInsets.only( left: 70, right: 60, bottom: 60, top: 10),
                child: CircleAvatar(
                  backgroundColor: Color.fromARGB(253, 253, 22, 22),
              radius: 100, 
              child: Text("Yanlış Sayınız: ${ benimTestim.printY()}" , style: TextStyle(fontSize: 20, color: Color.fromRGBO(0, 0, 0, 1) )), ),
               ),
