...
class Quiz_ispanyolca extends StatefulWidget {

   Quiz_ispanyolca({Key? key}) : super(key: key);

  @override
  State<Quiz_ispanyolca> createState() => _QuizState();
}

class _QuizState extends State<Quiz_ispanyolca> {
  SqlDb sqlDb = SqlDb();
